              ...
              <div class="card-body" style="display: block;">
                <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <a href="{{route('doctor.show',$doctor->id)}}" class=" ">{{$i}}</a>
                      </th>
                      <td>{{$doctor->name}}</td>
                      <td>{{$doctor->phone}}</td>
                      <td>{{$doctor->email}}</td>
                      ...
                      <td>
                        <div class="">
                          <div class="row">
                            <div class="col-md-6">
                              <a href="{{route('doctor.edit',$doctor->id)}}" class=" "><i class="fas fa-edit btn-primary btn"></i></a>
                            </div>
                            <div class="col-md-6">
                              <a href="" class="  " data-toggle="modal" data-target="#deleteDoctor{{ $doctor->id }}"><i class="fa fa-trash-o btn-danger btn"></i></a>
                            </div>
                          </div>          
                          <!-- Modal Start -->
