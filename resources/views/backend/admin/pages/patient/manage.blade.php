...
@section('dashboard-content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Patient Manage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body" style="display: block;">
                <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td scope="row">
                        <a href="{{route('patient.show',$patient->id)}}" class=" ">{{$i}}</a>
                      </td>
                      <td>{{$patient->name}}</td>
                      <td>{{$patient->phone}}</td>
                      <td>{{$patient->email}}</td>
                      ...
                      <td>
                        <a href="" class=" "><i class="btn-primary btn">Doctors</i></a>
                      </td>
                      <td>
                        <div class="">
                          <div class="row">
                            <div class="col-md-6">
                              <a href="{{route('patient.edit',$patient->id)}}" class=" "><i class="fas fa-edit btn-primary btn"></i></a>
                            </div>
                            <div class="col-md-6">
                              <a href="" class="  " data-toggle="modal" data-target="#deletePatient{{ $patient->id }}"><i class="fa fa-trash-o btn-danger btn"></i></a>
                            </div>
                          </div>          
                          <!-- Modal Start -->
